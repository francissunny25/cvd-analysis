...
from src.component.data_transformation import DataTransformation, DataConfigurationConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv('notebook\data\CVD_cleaned.csv')
            logging.info('Imported dataset as data frame.')
